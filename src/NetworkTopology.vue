...
export default {
  ...
  data() {
    return {
      nodes: [
        { id: 1, name: '控制器c1', x: 600, y: 200 },
        { id: 2, name: '交换机s1', x: 600, y: 400 },
        { id: 3, name: '主机h1', x: 400, y: 600 },
        { id: 4, name: '主机h2', x: 600, y: 600 },
        { id: 5, name: '主机h3', x: 800, y: 600 },
        { id: 6, name: '端口eh0', x: 500, y: 450 },
        { id: 7, name: '端口eh1', x: 400, y: 500 },
        { id: 8, name: '端口eh2', x: 600, y: 450 },
        { id: 9, name: '端口eh3', x: 600, y: 500 },
        { id: 10, name: '端口eh4', x: 700, y: 450 },
        { id: 11, name: '端口eh5', x: 800, y: 500 }
      ],
      links: [
        { source: 1, target: 2 },
        { source: 2, target: 6 },
